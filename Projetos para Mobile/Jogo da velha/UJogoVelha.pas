...
type
  ...
  TJogoVelha = class
    private
      ...
      procedure VeriicarFimDoJogo(const aJogador: TJogador;
...
begin
  Self.VeriicarFimDoJogo(aJogador, FPrimeiraLinha);
  Self.VeriicarFimDoJogo(aJogador, FSegundaLinha);
  Self.VeriicarFimDoJogo(aJogador, FTerceiraLinha);

  Self.VeriicarFimDoJogo(aJogador, FPrimeiraColuna);
  Self.VeriicarFimDoJogo(aJogador, FSegundaColuna);
  Self.VeriicarFimDoJogo(aJogador, FTerceiraColuna);

  Self.VeriicarFimDoJogo(aJogador, FPrimeiraDiagonal);
  Self.VeriicarFimDoJogo(aJogador, FSegundaDiagonal);
end;

procedure TJogoVelha.VeriicarFimDoJogo(const aJogador: TJogador;
