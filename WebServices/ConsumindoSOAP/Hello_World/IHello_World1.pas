...
// Version  : 1.0
// (03/02/2023 19:35:46 - - $Rev: 103843 $)
// ************************************************************************ //
...
type
  ...
  // ************************************************************************ //
  // Namespace : urn:Hello_WorldIntf-IHello_World
  // soapAction: urn:Hello_WorldIntf-IHello_World#%operationName%
  ...
  // URL       : http://localhost:9090/soap/IHello_World
  // ************************************************************************ //
...
initialization
  { IHello_World }
  InvRegistry.RegisterInterface(TypeInfo(IHello_World), 'urn:Hello_WorldIntf-IHello_World', '');
  InvRegistry.RegisterDefaultSOAPAction(TypeInfo(IHello_World), 'urn:Hello_WorldIntf-IHello_World#%operationName%');
